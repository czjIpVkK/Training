...
<form action="ManageUserDetails" method="POST">
    ...
    <input  name="u_balance" type="text" class="form-control"  placeholder="余额" value=${u_balance}>
    <input  name="u_credits" type="text" class="form-control"  placeholder="积分" value=${u_credits}>
    <input  name="u_isuse" type="text" class="form-control"  placeholder="是否禁用" value=${u_isuse}>
